...
export const Section = styled.div`
     ...
     box-shadow:  19px 19px 38px ${props => props.theme.shadowColor},
             -19px -19px 38px ${props => props.theme.shadowColor};
     ...
     &:hover{  
          box-shadow:  10px 10px 20px ${props => props.theme.hoverShadowColor},
             -10px -10px 20px ${props => props.theme.hoverShadowColor};

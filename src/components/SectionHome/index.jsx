...
const SectionHome = () => {
  ...
  return (
    <MainWrapper>
      ...
      <SectionsWrapper>
        <SpecialLink to='/finance-analytics-app/section1' onClick={() => { window.scrollTo(0, 0) }}>
          <FirstSection>
        ...
        <SpecialLink to='/finance-analytics-app/section2' onClick={() => { window.scrollTo(0, 0) }}>
          <SecondSection>
        ...
        <SpecialLink to='/finance-analytics-app/section3' onClick={() => { window.scrollTo(0, 0) }}>
          <ThirdSection>
        ...
        <SpecialLink to='/finance-analytics-app/section4' onClick={() => { window.scrollTo(0, 0) }}>
          <ForthSection>
        ...
        <SpecialLink to='/finance-analytics-app/section5' onClick={() => { window.scrollTo(0, 0) }}>
          <FifthSection>
